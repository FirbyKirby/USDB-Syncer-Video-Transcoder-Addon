...
if TYPE_CHECKING:
    ...
    from .backup_manager import BackupRestoreResult


class BackupRestoreResultsDialog(QtWidgets.QDialog):
    """Dialog showing results of backup restoration."""

    def __init__(self, result: BackupRestoreResult, parent: QWidget | None = None):
        super().__init__(parent)
        self.result = result
        self._setup_ui()

    def _setup_ui(self) -> None:
        self.setWindowTitle("Backup Restoration Complete")
        ...
        success_lbl = QtWidgets.QLabel(f"✓ Successfully restored: {self.result.backups_restored} backups")
